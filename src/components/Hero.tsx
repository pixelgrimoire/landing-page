  ...
  return (
    <section className="relative min-h-[92vh] flex items-center">
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          <h1 className="hero-title fade-up text-4xl sm:text-5xl lg:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-yellow-300 via-yellow-100 to-white smooth-font">
            Conjura tu software
          </h1>
          ...
          <div className="fade-up mt-8 flex gap-3" style={{animationDelay:'260ms'}}>
            <a href={MAIL_TO} className="hero-primary relative inline-flex items-center justify-center px-5 py-3 rounded-md bg-gradient-to-b from-yellow-400 to-yellow-500 text-black font-semibold hover:brightness-110 transition">✉️ Contacto</a>
            <a href="#pricing" className="hero-secondary px-5 py-3 rounded-md border border-white/20 text-white/90 hover:bg-white/5 transition">★ Planes</a>
          </div>
        </div>
